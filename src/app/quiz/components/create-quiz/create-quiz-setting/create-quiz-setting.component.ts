...
@Component({
  selector: 'app-create-quiz-setting',
  templateUrl: './create-quiz-setting.component.html',
  styleUrls: ['./create-quiz-setting.component.scss'],
...
export class CreateQuizSettingComponent implements OnInit, OnDestroy {
  shuffles = [
  ...
  addGrade() {
    (<FormArray>this.f['customPassingGrade']).push(this.makeGradeObj());
  }

  deleteGrade(customGradeOpts) {
    (this.f['customPassingGrade'] as FormArray).removeAt(customGradeOpts);
  }
