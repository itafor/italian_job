...
export class InvoiceComponent implements OnInit {
  ...
  onPage(offset, limit) {
    this.count = this.invoiceList.length;
    const start = this.offset * this.limit;
    const end = start + this.limit;
    this.rows = this.invoiceList;
  }
  ...
  showInvoice(content, dataRow) {
    this.addToTabs('Show Invoice', content, 'UPDATE_INVOICE');
    this.focusOnCreatedTab();
    this.invoiceToView = dataRow;
    console.log(this.invoiceToView);
  }
